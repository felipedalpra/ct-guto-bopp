/**
 * Ícones de marca usados nos CTAs.
 * Ficam aqui para que o card do professor e o botão flutuante desenhem
 * exatamente o mesmo WhatsApp — o ícone é parte do reconhecimento da ação.
 */
